...
} from "frontend/pages/workspace/_context/devtools.types";
import { Status } from "frontend/utils/request.status.utils";
import { DevtoolsDataProvider } from "frontend/pages/workspace/explorer/list/content.state";
import { DevtoolsExplorerRequest } from "frontend/pages/workspace/explorer/list/content.types";
...
export const Devtools = ({ children }: { children: React.ReactNode }) => {
  const dataMaxSize = 10000;
  ...
  useClientEvents({ client, workspace: activeWorkspace! });
