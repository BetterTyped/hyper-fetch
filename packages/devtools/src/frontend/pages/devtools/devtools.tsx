...
import { DevtoolsProvider, Sort } from "frontend/pages/devtools/devtools.context";
import {
  DevtoolsCacheEvent,
  DevtoolsModule,
  DevtoolsElement,
...
} from "frontend/pages/devtools/devtools.types";
import { Status } from "frontend/utils/request.status.utils";
import { Network } from "frontend/pages/devtools/network/network";
import { DevtoolsDataProvider } from "frontend/pages/devtools/explorer/list/content.state";
import { DevtoolsExplorerRequest } from "frontend/pages/devtools/explorer/list/content.types";
import { Explorer } from "frontend/pages/devtools/explorer/explorer";
import { Queues } from "frontend/pages/devtools/queues/queues";
import { Cache } from "frontend/pages/devtools/cache/cache";
import { Workspace } from "frontend/pages/workspace/workspace";
import { useClientEvents } from "frontend/hooks/use-client-events";
...
export const Devtools = <T extends ClientInstance>({
  ...
  const [position, setPosition] = useState<"Top" | "Left" | "Right" | "Bottom">("Right");
  ...
  useClientEvents({ client, workspace });
  ...
  return (
    ...
    >
      <div className="flex h-full">
        <Menu />
        <div className="mx-3 my-2 flex-1 bg-gray-700/60 rounded-lg shadow-lg">
          <Module />
        </div>
      </div>
    </DevtoolsProvider>
