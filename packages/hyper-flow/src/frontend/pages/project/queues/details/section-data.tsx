...
const StatBlock = ({
  ...
  <motion.div
    ...
    className="bg-gradient-to-br from-gray-700/30 to-gray-800/30 rounded-xl p-6 shadow-lg border border-gray-600/30 hover:border-gray-500/50 transition-all duration-300"
  >
...
const StatItem = ({ label, value }: { label: string; value: string | number }) => (
  <div className="flex justify-between items-center group">
    ...
    <span className="text-sm font-medium text-gray-200 group-hover:text-white transition-colors">{value}</span>
  </div>
);
