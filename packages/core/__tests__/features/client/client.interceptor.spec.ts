...
describe("Client [ Interceptor ]", () => {
  ...
  describe("When interceptor callbacks go into the execution loop", () => {
    it("should trigger __modifyErrorResponse async loop", async () => {
      ...
      await client.__modifyErrorResponse({ data: null, error: null, additionalData: { status: 400 } }, request);
    ...
    it("should trigger __modifySuccessResponse async loop", async () => {
      ...
      await client.__modifySuccessResponse({ data: null, error: null, additionalData: { status: 400 } }, request);
    ...
    it("should trigger __modifyResponse async loop", async () => {
      ...
      await client.__modifyResponse({ data: null, error: null, additionalData: { status: 400 } }, request);
  ...
  describe("When interceptor returns undefined value", () => {
    it("should throw onError method when request is not returned", async () => {
      ...
      await expect(
        client.__modifyErrorResponse({ data: null, error: null, additionalData: { status: 400 } }, request),
      ).rejects.toThrow();
    });
    it("should throw onSuccess method when request is not returned", async () => {
      ...
      await expect(
        client.__modifySuccessResponse({ data: null, error: null, additionalData: { status: 400 } }, request),
      ).rejects.toThrow();
    });
    it("should throw onResponse method when request is not returned", async () => {
      ...
      await expect(
        client.__modifyResponse({ data: null, error: null, additionalData: { status: 400 } }, request),
      ).rejects.toThrow();
    });
  });
});
