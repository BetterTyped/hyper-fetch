...
export declare type DispatcherOptionsType = {
...
export declare type DispatcherDumpValueType<Command extends CommandInstance = CommandInstance> = {
    requestId: string;
...
export declare type DispatcherData<Command extends CommandInstance = CommandInstance> = {
...
export declare type DispatcherLoadingEventType = {
    isLoading: boolean;
    isRetry: boolean;
    isOffline: boolean;
};
