...
export interface OperationMethods {
   ...
   */
  "findPets"(
    parameters?: Parameters<Paths.FindPets.QueryParameters> | null,
    data?: any,
    config?: AxiosRequestConfig,
  ): OperationResponse<Paths.FindPets.Responses.$200>;
  /**
   ...
   */
  "find pet by id"(
    parameters?: Parameters<Paths.FindPetById.PathParameters> | null,
    data?: any,
    config?: AxiosRequestConfig,
  ): OperationResponse<Paths.FindPetById.Responses.$200>;
  /**
   * deletePet - deletes a single pet based on the ID supplied
   */
  "deletePet"(
    parameters?: Parameters<Paths.DeletePet.PathParameters> | null,
    data?: any,
    config?: AxiosRequestConfig,
  ): OperationResponse<Paths.DeletePet.Responses.$204>;
}
