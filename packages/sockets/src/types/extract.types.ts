...
export type ExtractEmitterNameType<E> = E extends Emitter<any, any, infer A, any, any, any, any> ? A : never;
...
export type ExtractListenerNameType<E> = E extends Listener<any, infer A, any, any> ? A : never;
