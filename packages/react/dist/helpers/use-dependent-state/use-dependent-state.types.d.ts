import { Dispatcher, ExtractError, CacheValueType, ExtractResponse, ClientResponseType, CommandInstance, LoggerMethodsType } from "@better-typed/hyper-fetch";
import { isEqual } from "utils";
export declare type UseDependentStateProps<T extends CommandInstance> = {
    command: T;
...
export declare type UseDependentStateReturn<T extends CommandInstance> = [
...
export declare type UseDependentStateType<T extends CommandInstance = CommandInstance> = {
...
export declare type UseDependentStateActions<T extends CommandInstance> = {
