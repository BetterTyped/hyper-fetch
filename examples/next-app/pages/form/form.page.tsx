...
export const FormPage: React.FC = () => {
  ...
  // Patch
  const resultPatch = useSubmit(patchUser.setData({ email: "test", age: 12, name: "name" }).setParams({ userId: 1 }));

  // Queue
  const resultQueued = useSubmit(postFile.setData({ file: new File([""], "file.txt") }));
