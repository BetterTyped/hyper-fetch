...
- Supports request queueing and many [dispatching strategies](/docs/core/dispatcher#modes)!
...
- Provides structure [recipes](/docs/getting-started/development#1-project-structure) for large scale applications that
