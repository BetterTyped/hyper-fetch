...
When you need to use the pre-request interceptor to modify the command before it gets sent, you can use the `onRequest`
builder method.
...
Builder has the built in query params encoding function, you can modify it's options as you want or provide your own
function.
