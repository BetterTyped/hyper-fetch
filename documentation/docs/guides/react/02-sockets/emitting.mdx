...
[sockets guide](/guides/sockets/basics/emitters). The `emit` function takes the data payload as its first argument and
an optional acknowledgement callback as its second.
