...
Let's build an example that fetches a list of "live" activities and refreshes them every 5 seconds. We'll also display a
"Last Updated" timestamp to show the refresh in action.
