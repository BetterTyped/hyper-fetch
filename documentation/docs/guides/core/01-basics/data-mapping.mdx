...
When using the [SDK pattern](/docs/core/sdk), you can centralize all your response and request mappers in a single
...
Every request accessed through the SDK will automatically have its mapper applied. See the
[SDK Configuration docs](/docs/core/sdk#sdk-configuration-configure) for more details.
