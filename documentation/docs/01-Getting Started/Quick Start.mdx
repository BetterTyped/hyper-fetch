...
The first step in implementing Hyper Fetch is to initialize the **[Builder](/docs/Architecture/Builder)**. It manages
the basic configuration for connection to the server and all Hyper Fetch’s essential elements (i.e. instances of
