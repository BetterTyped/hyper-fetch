...
This is a quick start of the basic version of the library, to see other packages go here:

- ** [React Quick Start](/docs/React/Overview). **

:::info

The basic version of Hyper Fetch is not associated with any framework or library that is required to work.
