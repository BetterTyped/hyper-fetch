    ...
    <tbody>
      ...
      <tr>
        <td>
          ...
          <Tippy content="Receive every lifecycle response from any requests. Request start, progress, response start, success, error, finished.">
            <span>ℹ️</span>
          </Tippy>
        </td>
        <td>✅</td>
      ...
      <tr>
        <td>
          ...
          <Tippy content="Being able to synchronize queries queues between tabs which is required to present full persistence in browser">
            <span>ℹ️</span>
          </Tippy>
        </td>
        <td>🔴</td>
