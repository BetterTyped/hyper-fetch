...
Instead of removing mocker, you can also disable mocker and enable mocker at will with the `setEnableMocking` method.
...
mockedRequest.setEnableMocking(true); // Mocker is enabled once more
```
