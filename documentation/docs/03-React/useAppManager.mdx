...
also have options to manipulate it's global state. This hook uses the [`AppManager`](/docs/Architecture/Managers)
available on the [`Builder`](/docs/Architecture/Builder) instance.
