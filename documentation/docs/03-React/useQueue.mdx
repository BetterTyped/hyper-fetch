...
This hook is created to **controll the dispatcher queues**. It uses the [`Dispatcher`](/docs/Architecture/Dispatcher) to
read the actual value of the queue `based on the queueKey` retrived from command passed as first argument.
