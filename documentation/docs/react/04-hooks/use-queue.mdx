...
|--------|---------|-------------|
| `keepFinishedRequests` | `false` | When `true`, completed requests remain in the `requests` list instead of being removed after they finish. Useful for displaying upload/download history or a log of completed operations. |
