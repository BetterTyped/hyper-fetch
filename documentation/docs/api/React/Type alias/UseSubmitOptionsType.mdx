...
Defined in [hooks/use-submit/use-submit.types.ts:15](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/react/src/hooks/use-submit/use-submit.types.ts#L15)
