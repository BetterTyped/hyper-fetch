...
Defined in [helpers/use-tracked-state/use-tracked-state.types.ts:23](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/react/src/helpers/use-tracked-state/use-tracked-state.types.ts#L23)
