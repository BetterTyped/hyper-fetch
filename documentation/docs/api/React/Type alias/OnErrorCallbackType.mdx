...
Defined in [helpers/use-command-events/use-command-events.types.ts:95](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/react/src/helpers/use-command-events/use-command-events.types.ts#L95)
