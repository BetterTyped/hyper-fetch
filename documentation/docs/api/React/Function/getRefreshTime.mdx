...
Defined in [hooks/use-fetch/use-fetch.utils.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/react/src/hooks/use-fetch/use-fetch.utils.ts#L1)
