...
Defined in [hooks/use-queue/use-queue.constants.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/react/src/hooks/use-queue/use-queue.constants.ts#L5)
