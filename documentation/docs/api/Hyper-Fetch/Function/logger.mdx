...
Defined in [managers/logger/logger.manager.utils.ts:10](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/managers/logger/logger.manager.utils.ts#L10)
