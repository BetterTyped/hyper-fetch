...
Defined in [managers/command/command.manager.events.ts:27](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/managers/command/command.manager.events.ts#L27)
