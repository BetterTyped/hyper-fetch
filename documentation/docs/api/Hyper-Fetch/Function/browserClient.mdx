...
Defined in [client/fetch.client.browser.ts:4](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/client/fetch.client.browser.ts#L4)
