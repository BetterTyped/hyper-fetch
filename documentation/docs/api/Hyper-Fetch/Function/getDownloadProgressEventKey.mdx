...
Defined in [managers/command/command.manager.utils.ts:18](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/managers/command/command.manager.utils.ts#L18)
