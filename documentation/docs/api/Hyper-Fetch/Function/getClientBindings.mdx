...
Defined in [client/fetch.client.bindings.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/client/fetch.client.bindings.ts#L5)
