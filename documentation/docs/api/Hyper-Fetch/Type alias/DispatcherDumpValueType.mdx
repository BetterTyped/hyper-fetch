...
Defined in [dispatcher/dispatcher.types.ts:13](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/dispatcher/dispatcher.types.ts#L13)
