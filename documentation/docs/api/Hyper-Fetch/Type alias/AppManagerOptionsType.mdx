...
Defined in [managers/app/app.manager.types.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/managers/app/app.manager.types.ts#L1)
