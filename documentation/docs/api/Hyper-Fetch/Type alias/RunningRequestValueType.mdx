...
Defined in [dispatcher/dispatcher.types.ts:36](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/dispatcher/dispatcher.types.ts#L36)
