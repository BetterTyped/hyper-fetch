...
Defined in [dispatcher/dispatcher.types.ts:26](https://github.com/BetterTyped/hyper-fetch/blob/aff5c35a/packages/core/src/dispatcher/dispatcher.types.ts#L26)
