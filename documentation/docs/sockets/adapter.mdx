...
<div class="api-link">
  <div class="api-link-title">Weboscket Adapter</div>
  <div class="api-link-sub-title">

[Read the API Reference »](/api/sockets/Functions/WebsocketAdapter.mdx)

  </div>
</div>

<div class="api-link">
  <div class="api-link-title">SSE Adapter</div>
  <div class="api-link-sub-title">

[Read the API Reference »](/api/sockets/Functions/ServerSentEventsAdapter.mdx)
