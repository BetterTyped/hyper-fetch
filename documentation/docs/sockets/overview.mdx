...
<PackageDetails pkg="@hyper-fetch/sockets" />

> Sockets module was created to handle listeners and emitters on open connections. Our base `Hyper Fetch` package was
> created with different approach to things like interceptors or data exchange itself but has some architecture
> decisions in common, like singleton pattern.
