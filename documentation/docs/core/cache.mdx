...
url params and query params, but you can override it with custom key or even generic generator function.
...
const cacheKeyWithQueryParams = getUser.setQueryParams({ page: 1 }).cacheKey; // "/users?page=1"
// highlight-end
```
