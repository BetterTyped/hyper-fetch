...
[`Submit Dispatcher`](/docs/Core/Dispatcher) to handle requests and the [`Cache`](/docs/Core/Cache) to manage the
overall state of the data.

The minimum requirement for `useSubmit` is a prepared [`Command`](/docs/Core/Command).
...
Data and parameters can be passed in several ways. One option is to use methods on the [`Command`](/docs/Core/Command),
