...
To refresh the token, we can add a special `onError` interceptor to our **[Builder](/docs/Architecture/Builder)**. It
intercepts errors received in our requests and it is asynchronous, which allows for efficient handling of such cases.
