    ...
    <header className={clsx(styles.container)}>
      <div className={styles.animation}>
        ...
        >
          <defs>
            <linearGradient id="a">
              <stop stop-color="var(--ifm-color-primary-lightest)" />
              <stop offset="0.2" stop-color="var(--ifm-color-primary-light)" />
              <stop offset="0.4" stop-color="var(--ifm-color-primary-dark)" />
              <stop offset="0.6" stop-color="var(--ifm-color-primary)" />
            </linearGradient>
          </defs>
          <path
            fill="url(#a)"
          ...
          />
          <g fill="none" stroke="var(--ifm-navbar-search-input-background-color)" stroke-width="1">
      ...
      <div className={clsx("container", styles.wrapper)}>
        ...
        <div className={styles.buttons}>
          ...
          <Link className="button button--secondary button--lg" to="/examples/Setup">
            Examples
          </Link>
        </div>
      </div>
