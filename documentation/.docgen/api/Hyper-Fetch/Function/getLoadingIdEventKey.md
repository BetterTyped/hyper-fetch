...
Defined in [managers/command/command.manager.utils.ts:4](https://github.com/BetterTyped/hyper-fetch/blob/a5ae46b5/packages/core/src/managers/command/command.manager.utils.ts#L4)
