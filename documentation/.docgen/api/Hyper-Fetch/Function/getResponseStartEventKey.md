...
Defined in [managers/command/command.manager.utils.ts](https://github.com/BetterTyped/hyper-fetch/blob/982ac882/packages/core/src/managers/command/command.manager.utils.ts#L14)
