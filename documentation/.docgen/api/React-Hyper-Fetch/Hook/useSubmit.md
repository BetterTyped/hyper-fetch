...
Defined in [hooks/use-submit/use-submit.hooks.ts](https://github.com/BetterTyped/hyper-fetch/blob/982ac882/packages/react/src/hooks/use-submit/use-submit.hooks.ts#L28)
