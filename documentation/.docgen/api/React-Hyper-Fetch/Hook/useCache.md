...
Defined in [hooks/use-cache/use-cache.hooks.ts](https://github.com/BetterTyped/hyper-fetch/blob/982ac882/packages/react/src/hooks/use-cache/use-cache.hooks.ts#L8)
