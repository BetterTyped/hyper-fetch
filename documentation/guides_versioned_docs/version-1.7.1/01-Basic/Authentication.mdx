...
Authentication in Hyper Fetch consists of two steps. We will introduce changes in the **[Builder](/docs/Core/Builder)**
...
To refresh the token, we can add a special `onError` interceptor to our **[Builder](/docs/Core/Builder)**. It intercepts
