...
Defined in [dispatcher/dispatcher.types.ts:36](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/dispatcher/dispatcher.types.ts#L36)
