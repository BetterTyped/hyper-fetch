...
Defined in [managers/request/request.manager.utils.ts:4](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/managers/request/request.manager.utils.ts#L4)
