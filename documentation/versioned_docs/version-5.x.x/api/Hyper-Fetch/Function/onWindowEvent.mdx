...
Defined in [managers/app/app.manager.utils.ts:17](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/managers/app/app.manager.utils.ts#L17)
