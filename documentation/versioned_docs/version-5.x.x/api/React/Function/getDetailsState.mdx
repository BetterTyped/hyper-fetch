...
Defined in [helpers/use-tracked-state/use-tracked-state.utils.ts:16](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/helpers/use-tracked-state/use-tracked-state.utils.ts#L16)
