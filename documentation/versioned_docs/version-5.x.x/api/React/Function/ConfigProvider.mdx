...
Defined in [config-provider/config-provider.tsx:12](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/config-provider/config-provider.tsx#L12)
