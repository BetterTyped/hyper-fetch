...
Defined in [hooks/use-queue/use-queue.types.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-queue/use-queue.types.ts#L7)
