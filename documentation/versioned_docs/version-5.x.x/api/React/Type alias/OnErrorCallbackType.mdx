...
Defined in [helpers/use-request-events/use-request-events.types.ts:96](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/helpers/use-request-events/use-request-events.types.ts#L96)
