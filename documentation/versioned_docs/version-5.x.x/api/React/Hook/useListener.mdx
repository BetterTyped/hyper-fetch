...
Defined in [hooks/use-listener/use-listener.hooks.ts:14](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-listener/use-listener.hooks.ts#L14)
