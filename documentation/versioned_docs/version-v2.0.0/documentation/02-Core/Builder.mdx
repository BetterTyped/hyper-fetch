...
[Read the API Reference »](/api/Hyper-Fetch/Class/Builder.mdx)
...
### [Client](/api/Hyper-Fetch/Function/fetchClient.mdx)
...
### [CommandManager](/api/Hyper-Fetch/Class/CommandManager.mdx)
