...
Defined in [dispatcher/dispatcher.types.ts:26](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/dispatcher/dispatcher.types.ts#L26)
