...
Defined in [client/fetch.client.bindings.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/client/fetch.client.bindings.ts#L5)
