...
Defined in
[managers/command/command.manager.utils.ts:12](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/managers/command/command.manager.utils.ts#L12)
