...
Defined in [managers/app/app.manager.utils.ts:16](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/managers/app/app.manager.utils.ts#L16)
