...
Defined in
[helpers/use-tracked-state/use-tracked-state.utils.ts:33](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/helpers/use-tracked-state/use-tracked-state.utils.ts#L33)
