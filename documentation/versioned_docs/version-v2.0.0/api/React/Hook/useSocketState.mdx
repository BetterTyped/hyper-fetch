...
Defined in
[helpers/use-socket-state/use-socket-state.hooks.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/helpers/use-socket-state/use-socket-state.hooks.ts#L7)
