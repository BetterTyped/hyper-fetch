...
Defined in [hooks/use-emitter/use-emitter.hooks.ts:9](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/hooks/use-emitter/use-emitter.hooks.ts#L9)
