...
Defined in
[hooks/use-event-messages/use-event-messages.hooks.ts:14](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/hooks/use-event-messages/use-event-messages.hooks.ts#L14)
