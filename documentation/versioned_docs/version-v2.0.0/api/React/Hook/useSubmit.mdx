...
Defined in
[hooks/use-submit/use-submit.hooks.ts:29](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/hooks/use-submit/use-submit.hooks.ts#L29)
