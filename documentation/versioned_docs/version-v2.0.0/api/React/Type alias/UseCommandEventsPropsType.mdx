...
Defined in [helpers/use-command-events/use-command-events.types.ts:21](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/helpers/use-command-events/use-command-events.types.ts#L21)
