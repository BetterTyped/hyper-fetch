...
For submitting and mutating data on server use the [`useSubmit`](/documentation/04-React/useSubmit.mdx) hook that
automates command handling. There are tons of [options](/documentation/04-React/useFetch.mdx#options) to adjust this
hook so check out the [documentation](/documentation/04-React/useSubmit.mdx).
