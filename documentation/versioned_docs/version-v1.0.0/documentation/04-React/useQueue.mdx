...
[Read the API Reference »](/api/React-Hyper-Fetch/Hook/useQueue.md)
...
<!-- (@import React-Hyper-Fetch UseQueueOptionsType type=returns) -->
...
(@import React-Hyper-Fetch useQueue type=returns)

#### Request interface

(@import React-Hyper-Fetch QueueRequest type=returns)
