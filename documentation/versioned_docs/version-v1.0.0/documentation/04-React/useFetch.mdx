...
[Read the API Reference »](/api/React-Hyper-Fetch/Hook/useFetch.md)
...
[`useSubmit`](/documentation/04-React/useSubmit.mdx) hook.
...
(@import React-Hyper-Fetch UseFetchOptionsType type=returns)
...
(@import React-Hyper-Fetch UseFetchReturnType type=returns)
