...
Defined in
[managers/request/request.manager.utils.ts:17](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/managers/request/request.manager.utils.ts#L17)
