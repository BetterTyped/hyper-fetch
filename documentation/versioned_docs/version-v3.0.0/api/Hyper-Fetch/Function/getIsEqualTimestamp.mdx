...
Defined in [dispatcher/dispatcher.utils.ts:18](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/dispatcher/dispatcher.utils.ts#L18)
