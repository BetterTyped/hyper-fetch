...
Defined in [adapter/adapter.types.ts:92](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/adapter/adapter.types.ts#L92)
...
```ts
type ResponseReturnSuccessType<GenericDataType,AdapterType> = {
