...
Defined in [dispatcher/dispatcher.types.ts:36](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/dispatcher/dispatcher.types.ts#L36)
