...
Defined in [react/src/config-provider/config-provider.types.ts:22](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/config-provider/config-provider.types.ts#L22)
