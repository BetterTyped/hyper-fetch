...
Defined in
[react/src/hooks/use-listener/use-listener.hooks.ts:9](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/hooks/use-listener/use-listener.hooks.ts#L9)
