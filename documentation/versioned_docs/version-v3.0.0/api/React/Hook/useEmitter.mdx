...
Defined in
[react/src/hooks/use-emitter/use-emitter.hooks.ts:8](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/hooks/use-emitter/use-emitter.hooks.ts#L8)
