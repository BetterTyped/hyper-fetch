...
Defined in
[react/src/helpers/use-tracked-state/use-tracked-state.utils.ts:17](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/helpers/use-tracked-state/use-tracked-state.utils.ts#L17)
