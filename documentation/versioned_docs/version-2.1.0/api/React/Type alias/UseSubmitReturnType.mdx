...
Defined in [hooks/use-submit/use-submit.types.ts:46](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/react/src/hooks/use-submit/use-submit.types.ts#L46)
