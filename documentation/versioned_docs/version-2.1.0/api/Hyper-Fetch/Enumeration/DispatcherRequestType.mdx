...
Defined in [dispatcher/dispatcher.constants.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/dispatcher/dispatcher.constants.ts#L1)
