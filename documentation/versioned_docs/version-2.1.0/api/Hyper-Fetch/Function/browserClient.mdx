...
Defined in [client/fetch.client.browser.ts:4](https://github.com/BetterTyped/hyper-fetch/blob/993719ed/packages/core/src/client/fetch.client.browser.ts#L4)
