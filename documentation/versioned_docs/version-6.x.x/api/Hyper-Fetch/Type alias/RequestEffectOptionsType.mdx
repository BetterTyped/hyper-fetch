...
Defined in [effect/request.effect.types.ts:10](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/effect/request.effect.types.ts#L10)
