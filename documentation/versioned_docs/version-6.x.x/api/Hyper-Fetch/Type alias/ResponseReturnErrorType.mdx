...
Defined in [adapter/adapter.types.ts:105](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/adapter/adapter.types.ts#L105)
...
```ts
type ResponseReturnErrorType<GenericErrorType,Adapter> = {
  data: null; 
