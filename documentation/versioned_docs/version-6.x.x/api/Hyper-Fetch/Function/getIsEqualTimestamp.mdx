...
Defined in [dispatcher/dispatcher.utils.ts:18](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/dispatcher/dispatcher.utils.ts#L18)
