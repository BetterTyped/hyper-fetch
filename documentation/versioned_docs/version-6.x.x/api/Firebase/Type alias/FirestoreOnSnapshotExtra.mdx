...
Defined in [adapter/types/adapter.firestore.types.ts:62](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/adapter-firebase/src/adapter/types/adapter.firestore.types.ts#L62)
