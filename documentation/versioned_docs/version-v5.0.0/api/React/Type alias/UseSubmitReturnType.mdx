...
Defined in [hooks/use-submit/use-submit.types.ts:63](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-submit/use-submit.types.ts#L63)
