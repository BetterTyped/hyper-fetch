...
Defined in [hooks/use-submit/use-submit.hooks.ts:30](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-submit/use-submit.hooks.ts#L30)
