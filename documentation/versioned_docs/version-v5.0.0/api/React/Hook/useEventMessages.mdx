...
Defined in [hooks/use-event-messages/use-event-messages.hooks.ts:15](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-event-messages/use-event-messages.hooks.ts#L15)
