...
Defined in [hooks/use-emitter/use-emitter.hooks.ts:8](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/react/src/hooks/use-emitter/use-emitter.hooks.ts#L8)
