...
Defined in [managers/logger/logger.manager.types.ts:27](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/managers/logger/logger.manager.types.ts#L27)
