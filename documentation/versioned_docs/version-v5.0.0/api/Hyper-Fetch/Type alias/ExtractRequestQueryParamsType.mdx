...
```ts
import { ExtractRequestQueryParamsType } from "@hyper-fetch/core"
```
...
Defined in [types/fetch.types.ts:16](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/types/fetch.types.ts#L16)
