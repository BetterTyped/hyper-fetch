...
- Supports request queueing and many [dispatching strategies](/core/dispatcher.mdx#modes)!
...
- Provides structure [recipes](/getting-started/development.mdx#1-project-structure) for large scale applications that
