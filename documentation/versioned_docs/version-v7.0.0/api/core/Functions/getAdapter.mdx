...
```tsx
import { getAdapter } from "@hyper-fetch/core"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/c1b98634219cd481ccfc1f82d38d090bd4677605/packages/core/src/http-adapter/http-adapter.fetch.ts#L11">View the source code</a></div>
  </div>
...
```tsx
Adapter<FetchAdapterOptionsType, HttpMethodsType, number, HttpAdapterExtraType, null | string | QueryParamsType, undefined, string, DefaultMapperType, (queryParams: string | EmptyTypes | QueryParamsType, options: QueryStringifyOptionsType) => string, DefaultMapperType, DefaultMapperType>
```
