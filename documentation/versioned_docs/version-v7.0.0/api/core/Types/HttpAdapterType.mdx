---
sidebar_position: 1
title: HttpAdapterType
sidebar_label: HttpAdapterType
---
...
```tsx
import { HttpAdapterType } from "@hyper-fetch/core"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/core/src/http-adapter/http-adapter.types.ts#L8">View the source code</a></div>
  </div>
