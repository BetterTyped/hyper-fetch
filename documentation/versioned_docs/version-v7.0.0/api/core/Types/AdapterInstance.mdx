...
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/core/src/adapter/adapter.types.ts#L22">View the source code</a></div>
  </div>
