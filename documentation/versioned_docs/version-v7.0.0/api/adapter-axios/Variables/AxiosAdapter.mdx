...
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/c1b98634219cd481ccfc1f82d38d090bd4677605/packages/adapter-axios/src/adapter/adapter.ts#L8">View the source code</a></div>
  </div>
