---
sidebar_position: 1
title: firestoreAdminSockets
sidebar_label: firestoreAdminSockets
---
...
```tsx
import { firestoreAdminSockets } from "@hyper-fetch/firebase-admin"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/adapter-firebase-admin/src/firestore/firestore.sockets.ts#L15">View the source code</a></div>
  </div>
...
```tsx
firestoreAdminSockets(database: Firestore)
```
