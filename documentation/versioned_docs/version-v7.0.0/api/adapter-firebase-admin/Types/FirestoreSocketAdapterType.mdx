---
sidebar_position: 1
title: FirestoreSocketAdapterType
sidebar_label: FirestoreSocketAdapterType
---
...
```tsx
import { FirestoreSocketAdapterType } from "@hyper-fetch/firebase-admin"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/adapter-firebase-admin/src/adapter/types/adapter.firestore.types.ts#L19">View the source code</a></div>
  </div>
