---
sidebar_position: 1
title: UseTrackedStateActions
sidebar_label: UseTrackedStateActions
---
...
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/react/src/helpers/use-tracked-state/use-tracked-state.types.ts#L79">View the source code</a></div>
  </div>
...
<div class="api-docs__structure">
  ...
  <div class="api-docs__table-wrapper api-docs__returns undefined">
    <div class="api-docs__table-title">UseTrackedStateActions</div>
