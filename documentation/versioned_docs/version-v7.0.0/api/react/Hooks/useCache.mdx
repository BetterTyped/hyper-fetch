...
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/react/src/hooks/use-cache/use-cache.hooks.ts#L9">View the source code</a></div>
  </div>
...
```
  ...
  <div class="api-docs__table-wrapper api-docs__returns undefined">
    <div class="api-docs__table-title">useCache</div>
    <table class="api-docs__table">
      <thead>
        <tr>
          <th>Name</th>
...
```
        ...
        <tr class="api-docs__table-row">
          <td class="api-docs__table-name">invalidate</td>
          <td class="api-docs__table-type">
            <div class="api-docs__pre">
