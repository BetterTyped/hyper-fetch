---
sidebar_position: 1
title: ExtendListener
sidebar_label: ExtendListener
---
...
```tsx
import { ExtendListener } from "@hyper-fetch/sockets"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/sockets/src/listener/listener.types.ts#L66">View the source code</a></div>
  </div>
