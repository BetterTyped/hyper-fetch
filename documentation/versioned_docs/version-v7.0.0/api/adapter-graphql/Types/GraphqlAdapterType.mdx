---
sidebar_position: 1
title: GraphqlAdapterType
sidebar_label: GraphqlAdapterType
---
...
```tsx
import { GraphqlAdapterType } from "@hyper-fetch/graphql"
```
  ...
  <div class="api-docs__definition api-docs__details ">
    ...
    <div class="api-docs__info"><a href="https://github.com/BetterTyped/hyper-fetch/blob/f1b21d8c1923f0d0ea99c9a254d6135730665218/packages/adapter-graphql/src/adapter/adapter.types.ts#L13">View the source code</a></div>
  </div>
