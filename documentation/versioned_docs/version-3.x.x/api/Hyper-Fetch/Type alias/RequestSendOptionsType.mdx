...
Defined in
[request/request.types.ts:253](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/request/request.types.ts#L253)
...
```ts
type RequestSendOptionsType<Request> = FetchQueryParamsType<
