...
Defined in [managers/app/app.manager.types.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/app/app.manager.types.ts#L1)
