...
Defined in [managers/app/app.manager.types.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/managers/app/app.manager.types.ts#L1)
