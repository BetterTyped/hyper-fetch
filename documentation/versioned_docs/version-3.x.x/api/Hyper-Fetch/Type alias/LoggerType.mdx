...
Defined in [managers/logger/logger.manager.types.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/managers/logger/logger.manager.types.ts#L7)
