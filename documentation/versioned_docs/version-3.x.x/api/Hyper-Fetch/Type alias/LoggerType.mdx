...
Defined in
[managers/logger/logger.manager.types.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/logger/logger.manager.types.ts#L7)
