...
Defined in [managers/request/request.manager.utils.ts:14](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/request/request.manager.utils.ts#L14)
