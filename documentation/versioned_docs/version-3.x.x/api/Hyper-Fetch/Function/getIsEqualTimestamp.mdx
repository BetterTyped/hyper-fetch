...
Defined in [dispatcher/dispatcher.utils.ts:19](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/dispatcher/dispatcher.utils.ts#L19)
