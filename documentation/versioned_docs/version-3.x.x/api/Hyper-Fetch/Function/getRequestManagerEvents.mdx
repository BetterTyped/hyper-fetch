...
Defined in [managers/request/request.manager.events.ts:27](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/managers/request/request.manager.events.ts#L27)
