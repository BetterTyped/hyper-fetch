...
Defined in [managers/app/app.manager.events.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/app/app.manager.events.ts#L5)
