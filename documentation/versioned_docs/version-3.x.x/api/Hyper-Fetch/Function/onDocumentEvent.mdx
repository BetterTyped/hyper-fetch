...
Defined in [managers/app/app.manager.utils.ts:27](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/app/app.manager.utils.ts#L27)
