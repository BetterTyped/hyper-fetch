...
Defined in [dispatcher/dispatcher.utils.ts:9](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/dispatcher/dispatcher.utils.ts#L9)
