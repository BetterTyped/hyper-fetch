...
Defined in [client/client.utils.ts:38](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/core/src/client/client.utils.ts#L38)
...
```ts
interceptResponse<GlobalErrorType, AdapterType>(interceptors, response, request)
```
