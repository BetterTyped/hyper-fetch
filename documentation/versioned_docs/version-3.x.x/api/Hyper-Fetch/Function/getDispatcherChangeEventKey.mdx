...
Defined in [dispatcher/dispatcher.utils.ts:13](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/dispatcher/dispatcher.utils.ts#L13)
