...
Defined in [managers/logger/logger.manager.utils.ts:10](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/core/src/managers/logger/logger.manager.utils.ts#L10)
