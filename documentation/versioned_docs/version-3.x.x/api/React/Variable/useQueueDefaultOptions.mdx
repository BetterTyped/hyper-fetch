...
Defined in [hooks/use-queue/use-queue.constants.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/hooks/use-queue/use-queue.constants.ts#L5)
