...
Defined in [helpers/use-socket-state/use-socket-state.hooks.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/helpers/use-socket-state/use-socket-state.hooks.ts#L7)
