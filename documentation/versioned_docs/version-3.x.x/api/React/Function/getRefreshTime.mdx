...
Defined in [hooks/use-fetch/use-fetch.utils.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/hooks/use-fetch/use-fetch.utils.ts#L1)
