...
Defined in [react/src/utils/deep-equal.utils.ts:19](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/utils/deep-equal.utils.ts#L19)
