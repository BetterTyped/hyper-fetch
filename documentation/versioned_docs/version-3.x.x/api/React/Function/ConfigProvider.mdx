...
Defined in [config-provider/config-provider.tsx:12](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/config-provider/config-provider.tsx#L12)
