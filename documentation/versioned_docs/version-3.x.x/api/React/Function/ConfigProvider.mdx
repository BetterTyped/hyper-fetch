...
Defined in [react/src/config-provider/config-provider.tsx:12](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/config-provider/config-provider.tsx#L12)
