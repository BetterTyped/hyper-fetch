...
Defined in [hooks/use-fetch/use-fetch.types.ts:74](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/hooks/use-fetch/use-fetch.types.ts#L74)
