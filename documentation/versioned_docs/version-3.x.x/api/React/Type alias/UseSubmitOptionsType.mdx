...
Defined in [hooks/use-submit/use-submit.types.ts:21](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/hooks/use-submit/use-submit.types.ts#L21)
...
```ts
{
  ...
  dependencyTracking: boolean;
  disabled: boolean;
  initialData: ResponseType<Response, Error> | null;
}
```
