...
Defined in [react/src/types/invalidation.types.ts:3](https://github.com/BetterTyped/hyper-fetch/blob/c44d728f/packages/react/src/types/invalidation.types.ts#L3)
