...
Defined in [helpers/use-request-events/use-request-events.types.ts:95](https://github.com/BetterTyped/hyper-fetch/blob/3f01c37e/packages/react/src/helpers/use-request-events/use-request-events.types.ts#L95)
