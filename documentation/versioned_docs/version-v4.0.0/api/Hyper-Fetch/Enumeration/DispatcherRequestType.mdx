...
Defined in [dispatcher/dispatcher.constants.ts:1](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/dispatcher/dispatcher.constants.ts#L1)
