...
Defined in [managers/app/app.manager.utils.ts:17](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/managers/app/app.manager.utils.ts#L17)
