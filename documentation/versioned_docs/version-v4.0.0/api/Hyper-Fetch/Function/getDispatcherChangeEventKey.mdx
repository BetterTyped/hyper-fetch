...
Defined in [dispatcher/dispatcher.utils.ts:12](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/dispatcher/dispatcher.utils.ts#L12)
