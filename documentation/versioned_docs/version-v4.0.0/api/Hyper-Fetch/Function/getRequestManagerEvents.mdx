...
Defined in
[managers/request/request.manager.events.ts:27](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/managers/request/request.manager.events.ts#L27)
