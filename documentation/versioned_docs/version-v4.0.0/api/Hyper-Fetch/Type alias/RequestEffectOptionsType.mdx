...
Defined in [effect/request.effect.types.ts:10](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/effect/request.effect.types.ts#L10)
