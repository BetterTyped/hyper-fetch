...
Defined in [dispatcher/dispatcher.types.ts:36](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/dispatcher/dispatcher.types.ts#L36)
