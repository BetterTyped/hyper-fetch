...
Defined in [react/src/hooks/use-queue/use-queue.types.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-queue/use-queue.types.ts#L7)
