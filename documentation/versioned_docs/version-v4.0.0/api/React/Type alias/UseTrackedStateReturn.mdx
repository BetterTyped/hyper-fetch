...
Defined in [react/src/helpers/use-tracked-state/use-tracked-state.types.ts:26](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/helpers/use-tracked-state/use-tracked-state.types.ts#L26)
