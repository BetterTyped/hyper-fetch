...
Defined in [react/src/hooks/use-cache/use-cache.types.ts:12](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-cache/use-cache.types.ts#L12)
