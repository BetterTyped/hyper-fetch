...
Defined in
[react/src/hooks/use-listener/use-listener.hooks.ts:9](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-listener/use-listener.hooks.ts#L9)
