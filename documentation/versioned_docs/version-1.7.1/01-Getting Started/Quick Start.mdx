...
The first step in implementing Hyper Fetch is to initialize the **[Builder](/docs/Core/Builder)**. It manages the basic
...
**[commands](/docs/Core/Command)** and assign types to them.
