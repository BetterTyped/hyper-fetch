...
Defined in [react/src/hooks/use-event-messages/use-event-messages.hooks.ts:15](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-event-messages/use-event-messages.hooks.ts#L15)
