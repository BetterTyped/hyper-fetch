...
Defined in [react/src/helpers/use-socket-state/use-socket-state.hooks.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/helpers/use-socket-state/use-socket-state.hooks.ts#L7)
