...
Defined in [react/src/hooks/use-submit/use-submit.hooks.ts:30](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-submit/use-submit.hooks.ts#L30)
