...
Defined in [react/src/utils/deep-equal.utils.ts:19](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/utils/deep-equal.utils.ts#L19)
