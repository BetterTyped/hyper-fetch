...
Defined in [managers/app/app.manager.events.ts:5](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/managers/app/app.manager.events.ts#L5)
