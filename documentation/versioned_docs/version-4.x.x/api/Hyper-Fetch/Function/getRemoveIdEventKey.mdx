...
Defined in [managers/request/request.manager.utils.ts:6](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/managers/request/request.manager.utils.ts#L6)
