...
Defined in [react/src/helpers/use-request-events/use-request-events.types.ts:29](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/helpers/use-request-events/use-request-events.types.ts#L29)
