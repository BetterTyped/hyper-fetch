...
Defined in [react/src/hooks/use-submit/use-submit.types.ts:21](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-submit/use-submit.types.ts#L21)
