...
Defined in [react/src/config-provider/config-provider.types.ts:12](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/config-provider/config-provider.types.ts#L12)
