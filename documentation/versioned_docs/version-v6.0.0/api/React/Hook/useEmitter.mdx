...
Defined in
[react/src/hooks/use-emitter/use-emitter.hooks.ts:8](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-emitter/use-emitter.hooks.ts#L8)
