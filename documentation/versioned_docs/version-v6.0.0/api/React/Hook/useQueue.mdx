...
Defined in
[react/src/hooks/use-queue/use-queue.hooks.ts:14](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/hooks/use-queue/use-queue.hooks.ts#L14)
