...
Defined in
[react/src/helpers/use-tracked-state/use-tracked-state.utils.ts:35](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/react/src/helpers/use-tracked-state/use-tracked-state.utils.ts#L35)
