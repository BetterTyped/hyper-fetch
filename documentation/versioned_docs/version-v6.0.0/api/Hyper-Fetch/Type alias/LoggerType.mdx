...
Defined in [managers/logger/logger.manager.types.ts:7](https://github.com/BetterTyped/hyper-fetch/blob/c3e2c45/packages/core/src/managers/logger/logger.manager.types.ts#L7)
