...
Defined in [managers/logger/logger.manager.utils.ts:10](https://github.com/BetterTyped/hyper-fetch/blob/cc329b91/packages/core/src/managers/logger/logger.manager.utils.ts#L10)
